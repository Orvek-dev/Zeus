...
STALE_PUBLIC_EVIDENCE_MARKERS: Final[tuple[str, ...]] = (
    ...
    "1398 public tests",
    "tests-1405%20passed",
    "`1405` public tests passed",
    "1405 public tests",
    "tests-1412%20passed",
    "`1412` public tests passed",
    "1412 public tests",
    "tests-1420%20passed",
    "`1420` public tests passed",
    "1420 public tests",
    "tests-1428%20passed",
    "`1428` public tests passed",
    "1428 public tests",
    "tests-1433%20passed",
    "`1433` public tests passed",
    "1433 public tests",
    "tests-1456%20passed",
    "`1456` public tests passed",
    "1456 public tests",
    "tests-1462%20passed",
    "`1462` public tests passed",
    "1462 public tests",
    "tests-1467%20passed",
    "`1467` public tests passed",
    "1467 public tests",
    "tests-1490%20passed",
    "`1490` public tests passed",
    "1490 public tests",
    "`8/8` checks passed",
    "8/8 total",
)
