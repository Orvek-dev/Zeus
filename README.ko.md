...
잡습니다. 공개 `v5.8.0` 릴리스는 local-first governed platform boundary입니다.
...
Governed Live Connector Platform, Live Platform Beta status,
...
| Package build | `zeus-agent==5.0.0` sdist/wheel build passed |
