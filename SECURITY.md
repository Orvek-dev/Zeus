...
`v0.1.0` is a governed runtime foundation. It includes deterministic local scenarios, provider and tool interfaces, transport state, gateway/workflow scaffolds, and verification surfaces. It is not a hard-isolated remote execution platform by itself.
