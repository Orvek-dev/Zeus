...
| Higher-Order Agent OS | Persona, Objective Compiler, governed connectors, TUI cockpit contract, recursive improvement review, plugin skeleton, remote sandbox contract, tenant/auth contract, and public production boundary are reported as one product surface. |
