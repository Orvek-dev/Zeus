...
<p align="center">
  <a href="https://github.com/Orvek-dev/Zeus/releases/tag/v1.6.0"><img alt="Version" src="https://img.shields.io/badge/version-1.6.0-2ea44f"></a>
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-1389%20passed-1f883d">
...
an unconstrained chat loop. The public `v1.6.0` source release builds on the
...
Operation Runtime, then adds Real Self Evolution Runtime: provider profiles, governed local
...
self-evolution promotion block, explicit
...
`v1.2.0` includes Real MCP Runtime on top of Real Provider Runtime and the
public MCP Owned Client Live checkpoint. It proves provider profile reporting,
...
| Package build | Editable install, sdist, and wheel build for `zeus-agent==1.6.0` | passed |
...
`v1.6.0` is the sixth post-stable governed live platform expansion. The
...
| [Security policy](SECURITY.md) | Public security posture and current v1.6.0 boundary |
