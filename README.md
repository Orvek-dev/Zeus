...
center of gravity. The public `v4.0.0` release is a local-first, governed
platform boundary: goal intelligence, cognitive-provider activation,
productized platform status, provider/MCP/tool/gateway/runtime contracts,
...
The latest public-safe local evidence snapshot was measured on 2026-06-06.
...
| Package build | sdist and wheel build for `zeus-agent==4.0.0` passed |
