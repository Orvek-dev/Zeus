...
<p align="center">
  <a href="https://github.com/Orvek-dev/Zeus/releases/tag/v1.5.0"><img alt="Version" src="https://img.shields.io/badge/version-1.5.0-2ea44f"></a>
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-1381%20passed-1f883d">
...
an unconstrained chat loop. The public `v1.5.0` source release builds on the
...
Operation Runtime: provider profiles, governed local
...
retention delete, skill-learning memory bridge, promotion block, explicit
...
| Package build | Editable install, sdist, and wheel build for `zeus-agent==1.5.0` | passed |
...
`v1.5.0` is the fifth post-stable governed live platform expansion. The
...
| [Security policy](SECURITY.md) | Public security posture and current v1.5.0 boundary |
