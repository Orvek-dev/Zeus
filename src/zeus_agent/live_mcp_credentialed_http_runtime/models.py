...
LiveMcpCredentialedHttpDecision = Literal["executed", "blocked"]

_MODEL_CONFIG: Final = ConfigDict(extra="forbid", frozen=True, hide_input_in_errors=True)


class LiveMcpCredentialedHttpResult(BaseModel):
    ...
    mcp_credentialed_http: bool = False
    sealed_credential_bound: bool = False
    mcp_envelope_bound: bool = False
    mcp_request_body_bound: bool = False
