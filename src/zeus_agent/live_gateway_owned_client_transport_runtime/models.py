...
GatewayOwnedClientTransportKind = Literal["external_http"]

_MODEL_CONFIG: Final = ConfigDict(extra="forbid", frozen=True, hide_input_in_errors=True)


class LiveGatewayOwnedClientRequest(BaseModel):
...
class LiveGatewayOwnedClientReceipt(BaseModel):
    model_config = _MODEL_CONFIG
    ...
    cleanup_receipt: str = "gateway-owned-client-closed"


class LiveGatewayOwnedClient(Protocol):
    def deliver(self, request: LiveGatewayOwnedClientRequest) -> LiveGatewayOwnedClientReceipt:
        ...


class StaticGatewayOwnedClient:
...
class LiveGatewayOwnedClientTransportResult(BaseModel):
    model_config = _MODEL_CONFIG
    ...
    transport_kind: Optional[GatewayOwnedClientTransportKind]
