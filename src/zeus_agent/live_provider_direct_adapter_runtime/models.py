...
ProviderDirectAdapterTransportKind = Literal["external_http"]

_MODEL_CONFIG: Final = ConfigDict(extra="forbid", frozen=True, hide_input_in_errors=True)


class LiveProviderDirectAdapterRequest(BaseModel):
...
class LiveProviderDirectAdapterReceipt(BaseModel):
    model_config = _MODEL_CONFIG
    ...
    cleanup_receipt: str = "provider-direct-client-closed"


class LiveProviderDirectAdapterClient(Protocol):
    def send(self, request: LiveProviderDirectAdapterRequest) -> LiveProviderDirectAdapterReceipt:
        ...


class StaticProviderDirectAdapterClient:
...
class LiveProviderDirectAdapterResult(BaseModel):
    model_config = _MODEL_CONFIG
    ...
    transport_kind: Optional[ProviderDirectAdapterTransportKind]
    execution_ref: Optional[str]
    cleanup_receipt: Optional[str]
    blocked_reasons: tuple[str, ...] = ()
    provider_direct_adapter: bool = False
