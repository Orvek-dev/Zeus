...
ProviderOwnedClientLiveDecision = Literal["report", "blocked"]
ProviderOwnedClientLiveScenario = Literal[
    "status",
...
class ProviderOwnedClientLiveContract(BaseModel):
    model_config = _MODEL_CONFIG

    decision: ProviderOwnedClientLiveDecision
    target_version: str
    release_stage: Literal["provider_owned_client_live"]
    objective_contract_id: str
    scenario: ProviderOwnedClientLiveScenario
    blocked_reasons: tuple[str, ...] = ()
    provider_owned_client_live_contract_available: bool = True
    provider_owned_client_transport_available: bool = True
    owned_client_adapter_available: bool = True
    ...
    def with_secret_scan(self) -> ProviderOwnedClientLiveContract:
