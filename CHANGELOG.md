...
- Local Codex harness packs, private planning notes, evidence logs, runtime databases, and internal operating artifacts are intentionally excluded from the public release.
