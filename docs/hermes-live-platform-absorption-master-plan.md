...
The public v0.10.0 boundary is designed/prepared/dry-run/future for live-capable
...
Measured in the public v0.10.0 release tree:

| Area | Current Zeus |
| --- | ---: |
| Public source/test/docs/config files | 1,058 |
| `src` Python source lines | 73,762 |
| `tests` Python source lines | 38,754 |
| `docs` Markdown lines | 2,846 |
| Python test files | 287 |
| CLI/product commands | 223 |
...
| --- | ---: | ---: | ---: |
| Runtime Python LOC | 73.8k source / 64.3k non-comment | Hermes is materially larger and live | 180k-280k useful runtime LOC |
| Test LOC | 38.8k source / 31.6k non-comment | broad tests across agent/gateway/tools/providers | 120k+ test LOC |
| Runtime files | 727 Python modules in `src/zeus_agent` | broad multi-surface runtime | 700-1,000 useful runtime files |
| Test files | 287 | broad unit/integration/e2e coverage | 700+ test files |
