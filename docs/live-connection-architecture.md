...
The current public `v4.1.0` boundary does not claim these live integrations are
...
## Current v4.1.0 Governed Boundary

`v4.1.0` includes the accumulated governed local surfaces from the v0.6.0
through v4.1.0 release program:

- deterministic total architecture CLI/eval surfaces;
- release-gated ULW status for the v0.6.0 -> v4.1.0 program;
