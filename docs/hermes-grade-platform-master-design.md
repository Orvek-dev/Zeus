...
It does not replace the current v0.7.0 implementation boundary. It defines the
...
- `src/zeus_agent`: 721 Python files, 72,966 source lines, 63,562 non-comment
  Python LOC.
- `tests`: 284 Python test files, 38,360 source lines, 31,212 non-comment
  Python LOC.
- `docs`: 8 public documents, 2,824 lines.
- Source CLI registration: 220 deterministic commands when run from the source
...
| --- | ---: | ---: | ---: |
| Runtime files | 721 | 1,499 | 700+ useful runtime files |
| Python LOC | 63,562 | 324,243 | 120k-170k useful runtime LOC |
| Test files | 284 | 1,410 | 500+ test/integration files |
| Docs lines | 2,824 | 436k+ full docs/reference | 30k+ practical product/developer docs |
| CLI/product commands | 220 deterministic commands | broad `hermes` CLI/gateway/API/library | 100+ user/product commands |
