...
The public `v1.0.0-rc.8` code does not claim all live surfaces are production-active.
...
Provider Live Opt-in boundary, Provider Owned Client Live boundary, and live
...
- CLI eval surfaces;
- 1314 public tests, a 10/10 final architecture eval, and a 9/9 total
  architecture eval;
- release-gated ULW status for the v0.6.0 -> v1.0.0-rc.8 program with
  v1.0.0-rc.8 Provider Owned Client Live checkpoint reporting;
