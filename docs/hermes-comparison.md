...
- CLI eval surfaces;
- 1324 public tests, a 10/10 final architecture eval, and a 9/9 total
  architecture eval;
- release-gated ULW status for the v0.6.0 -> v1.0.0 program with
  v1.0.0 stable governed live platform checkpoint reporting;
