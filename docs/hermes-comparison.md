...
The public `v0.5.0` code does not claim all live surfaces are production-active.
...
| Live capability | Mature live ecosystem with many providers, gateways, tools, MCP, cron, and terminal/browser backends | v0.5.0 is a local deterministic total-architecture foundation with stabilized Zeus Core Language; live integrations are designed behind the same governance boundary |
...
- CLI eval surfaces;
- 1230 public tests, a 10/10 final architecture eval, and a 9/9 total
  architecture eval;
