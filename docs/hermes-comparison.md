...
The public `v1.4.0` code does not claim all live surfaces are production-active.
...
Real MCP Runtime boundary, Real Platform Runtime boundary, Real Execution Runtime boundary, and live connection design those
...
- CLI eval surfaces;
- 1372 public tests, a 10/10 final architecture eval, and a 9/9 total
  architecture eval;
- release-gated ULW status for the v0.6.0 -> v1.4.0 program with
  v1.4.0 real execution runtime checkpoint reporting;
